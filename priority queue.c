/*
Q2) Write a program to implement priority queue where each element 
is associated with an priority number. Here insertion will be done 
from rear counter but, deletion will be done based on the priority.
*/
#include <stdio.h>
#include <stdlib.h>
